...
<?php endforeach; ?>
        <main class="main-wrapper transactions-detail">
            <div class="ps-lg-0">
                <h2 class="text-4xl fw-bold color-palette-1 mb-30">Bank</h2>
                <div class="latest-transaction">
                    <p class="text-3xl fw-medium color-palette-1 mb-14">Transfer Bank</p>
                    <div class="main-content main-content-table overflow-auto">
                        <table class="table table-striped">
                            <thead>
                                <tr class="color-palette-1 text-2xl">
                                    <th scope="col">No</th>
                                    <th scope="col">Invoice</th>
                                    <th scope="col">Bank</th>
                                    <th scope="col">Name Bank</th>
                                    <th scope="col">Name</th>
                                    <th scope="col">Image Transfer</th>
                                </tr>
                            </thead>
                            ...
                            <?php $i=1; foreach($bookings as $booking): ?>
                                                        ...
                                                        " class="align-middle">
                                                            <td>
                                                                <p class="fw-medium color-palette-1 m-0"><?= $i++; ?>
                                                                </p>
                                                            </td>
                                                            <td>
                                                            ...
                                                            <td>
                                                        <?php if($booking->name_bank == "bca"): ?>
                                                            <img class="float-start me-3 mb-lg-0 mb-3" src="<?= base_url(); ?>assets/img/logo-bca.jpg"
                                                                    width="70" height="30" alt="">
                                                        <?php elseif($booking->name_bank == "mandiri"): ?>
                                                            <img class="float-start me-3 mb-lg-0 mb-3" src="<?= base_url(); ?>assets/img/logo-mandiri.jpg"
                                                                    width="70" height="30" alt="">
                                                        <?php else: ?>
                                                        <?php endif; ?>
                                                            </td>
                                                            <td>
                                                                <p class="fw-medium color-palette-1 m-0"><?= $booking->name_bank; ?>
                                                                </p>
                                                            </td>
                                                            <td>
                                                            <p class="fw-medium color-palette-1 m-0">
                                                                   <?= $booking->name_pengirim; ?>
                                                                </p>
                                                            </td>
                                                            <td>
                                                            <img class="float-start me-3 mb-lg-0 mb-3 zoom" src="<?= base_url(); ?>assets/img/<?= $booking->bukti_transfer; ?>
                                                            "
                                                                    width="70" height="30" alt="">
                                                            </td>
                                                        </tr>
