                    ...
                    <div class="content pt-50 pb-30 ps-30">
                        ...
                        <div class="menus">
                            ...
                            <!-- <div class="item mb-30">
                                ...
                                <p class="item-title m-0">
                                    <a href="<?= base_url("admin_controller/setting"); ?>" class="text-lg text-decoration-none">Settings</a>
                                </p>
                            </div> -->
                            <div class="item mb-30">
                                <svg class="icon me-3" width="25" height="25" viewBox="0 0 25 25" fill="none"
        ...
        <main class="main-wrapper transactions-detail">
            <div class="ps-lg-0">
                ...
                <div class="top-up-categories mb-30">
                    <p class="text-lg fw-medium color-palette-1 mb-14">Bookings Categories</p>
                            ...
                            <div class="col-lg-4 ps-15 pe-15 pb-lg-0 pb-4">
                                <div class="categories-card">
                                    <div class="d-flex align-items-center mb-24">
                                        ...
                                        <p class="color-palette-1 mb-0 ms-12">Most Picked<br> Categories</p>
                                    </div>
                                    <div>
                                        <p class="text-sm color-palette-2 mb-1">Total Spent</p>
                                        <?php foreach($mostpickeds as $mostpicked): ?>
                                        <p class="text-2xl color-palette-1 fw-medium m-0">Rp
                                        <?= number_format($mostpicked->total,3,'.','.'); ?>
                                        </p>
                                        <?php endforeach; ?>
                                    </div>
                                </div>
                            ...
                            <div class="col-lg-4 ps-15 pe-15 pb-lg-0 pb-4">
                                <div class="categories-card">
                                    <div class="d-flex align-items-center mb-24">
                                        ...
                                        <p class="color-palette-1 mb-0 ms-12">Houses with<br> beauty backyard</p>
                                    </div>
                                    <div>
                                        <p class="text-sm color-palette-2 mb-1">Total Spent</p>
                                        <?php foreach($houses as $house): ?>
                                        <p class="text-2xl color-palette-1 fw-medium m-0">Rp
                                        <?= number_format($house->total,3,'.','.'); ?>
                                        </p>
                                        <?php endforeach; ?>
                                    </div>
                                </div>
                            ...
                            <div class="col-lg-4 ps-15 pe-15 pb-lg-0 pb-4">
                                <div class="categories-card">
                                    <div class="d-flex align-items-center mb-24">
                                        ...
                                        <p class="color-palette-1 mb-0 ms-12">Hotels with large<br> living room</p>
                                    </div>
                                    <div>
                                        <p class="text-sm color-palette-2 mb-1">Total Spent</p>
                                        <?php foreach($hotels as $hotel): ?>
                                        <p class="text-2xl color-palette-1 fw-medium m-0">Rp
                                        <?= number_format($hotel->total,3,'.','.'); ?>
                                        </p>
                                        <?php endforeach; ?>
                                    </div>
                                </div>
                ...
                <div class="latest-transaction">
                    <p class="text-lg fw-medium color-palette-1 mb-14">Latest Bookings</p>
                        ...
                        <table class="table table-borderless">
                            ...
                            <?php foreach($bookings as $booking): ?>
                                                        ...
                                                        " class="align-middle">
                                                            ...
                                                            <td>
                                                                <a href="<?= base_url(); ?>admin_controller/delete_booking/<?= $booking->id_user; ?>
                                                                 "
                                                                    class="btn btn-status rounded-pill text-sm">
                                                                    <svg xmlns="http://www.w3.org/2000/svg" width="16" height="16" fill="currentColor" class="bi bi-archive-fill" viewBox="0 0 16 16">
                                                                        <path d="M12.643 15C13.979 15 15 13.845 15 12.5V5H1v7.5C1 13.845 2.021 15 3.357 15h9.286zM5.5 7h5a.5.5 0 0 1 0 1h-5a.5.5 0 0 1 0-1zM.8 1a.8.8 0 0 0-.8.8V3a.8.8 0 0 0 .8.8h14.4A.8.8 0 0 0 16 3V1.8a.8.8 0 0 0-.8-.8H.8z"/>
                                                                    </svg>
                                                                </a>
                                                                <a href="<?= base_url(); ?>admin_controller/edit_booking/<?= $booking->id_user; ?>"
                                                                    class="btn btn-status rounded-pill text-sm">
