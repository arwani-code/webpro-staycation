...
<?php endforeach; ?>
        <main class="main-wrapper transactions-detail">
            <div class="ps-lg-0">
                <h2 class="text-4xl fw-bold color-palette-1 mb-30">Bookings</h2>
                <div class="latest-transaction">
                    <p class="text-3xl fw-medium color-palette-1 mb-14">Last Bookings</p>
                        ...
                        <table class="table table-striped">
                            ...
                            <?php $i=1; foreach($bookings as $booking): ?>
                                                        ...
                                                        " class="align-middle">
                                                            ...
                                                            <td>
                                                                <p class="fw-medium color-palette-1 m-0"><?= $booking->start_booking; ?> s/d <?= $booking->end_booking; ?>
                                                                </p>
                                                            </td>
                                                            <td>
                                                                <p class="fw-medium color-palette-1 m-0"><?= $booking->name_order; ?>
                                                                </p>
                                                            </td>
                                                            <td>
