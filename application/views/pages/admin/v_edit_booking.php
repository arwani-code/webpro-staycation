...
<main class="main-wrapper">
            ...
            <div class="ps-lg-0">
                <h2 class="text-4xl fw-bold color-palette-1 mb-30">Edit Member  #<?= $booking->id_user; ?>
                </h2>
                <div class="bg-card pt-30 ps-30 pe-30 pb-30">
                    <form method="POST" action="<?= base_url(); ?>admin_controller/update_booking/<?= $booking->id_user; ?>
                    
                    ">
                        <div class="pt-10">
                            <label for="name" class="form-label text-lg fw-medium color-palette-1 mb-10">Username</label>
                            <input type="text" class="form-control rounded-pill text-lg" id="name" name="username"
                                aria-describedby="username" value="<?= $booking->username; ?>
                                " >
                            <input type="hidden" name="<?= $booking->id_user; ?>
                            ">    
                        </div>
                        <div class="pt-30">
                            ...
                            <input type="email" class="form-control rounded-pill text-lg" id="email" name="email"
                                aria-describedby="email" value="<?= $booking->email; ?>
                                ">
                        </div>
                        <div class="pt-30">
                            ...
                            <input type="tel" class="form-control rounded-pill text-lg" id="phone" name="phone"
                                aria-describedby="phone" value="<?= $booking->phone; ?>
                                ">
                        </div>
