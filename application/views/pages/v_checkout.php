...
<section class="checkout mx-auto pt-md-100 pb-md-145 pt-30 pb-30">
        <div class="container-fluid">
            ...
            <div class="title-text pt-md-50 pt-0">
                ...
                <p class="text-lg color-palette-1 mb-0">Waktunya untuk untuk senang-senang</p>
            </div>
        <?php foreach($get_bookings as $booking): ?>
            <div class="game-checkout d-flex flex-row align-items-center pt-md-50 pb-md-50 pt-30 pb-30">
                <div class="pe-4">
                    <div class="cropped">
                        <img src="<?= base_url(); ?>/assets/img/<?= $booking->imageUrl; ?>
                        " class="img-fluid" alt="<?= $booking->category_order; ?>
                        ">
                    </div>
                </div>
                <div>
            ...
            <div class="purchase pt-md-50 pt-30">
                ...
                <p class="text-lg color-palette-1 mb-20">Booking ID <span class="purchase-details">#<?= $booking->id_user; ?></span></p>
                <p class="text-lg color-palette-1 mb-20">Time  <span class="purchase-details"><?= $booking->days; ?> hari
                </span></p>
                <p class="text-lg color-palette-1 mb-20">Price <span class="purchase-details">Rp <?= $booking->price_order; ?>.000,00
                </span></p>
            ...
            <div class="payment pt-md-50 pb-md-50 pt-10 pb-10">
                ...
                <p class="text-lg color-palette-1 mb-20">Bank Account Name  <span class="purchase-details"><?= $booking->name_pengirim; ?>
                </span></p>
                <p class="text-lg color-palette-1 mb-20">Type <span class="payment-details">Worldwide Transfer</span>
                </p>
                <p class="text-lg color-palette-1 mb-20">Bank Name <span class="payment-details"><?= $booking->name_bank; ?>
                </span></p>
            </div>
